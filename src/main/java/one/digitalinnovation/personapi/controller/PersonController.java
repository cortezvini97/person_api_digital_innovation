...
public class PersonController
{
    ...
    public MessageResponseDTO createUser(@RequestBody @Valid PersonDTO personDTO)
    {
    ...
    @PutMapping("/{id}")
    public MessageResponseDTO update(@PathVariable Long id, @RequestBody @Valid PersonDTO personDTO) throws PersonalNotFoundException {
